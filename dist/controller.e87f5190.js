...
var API_URL = 'https://api.frankfurter.app/';
...
exports.getCurrencyTimeSeries = exports.searchCurrency = exports.getCurrencies = exports.currenciesListFilter = exports.state = void 0;
...
var sortByRelevancy = function sortByRelevancy(value, searchTerm) {
  if (value === searchTerm) return 2;
  if (value.startsWith(searchTerm)) return 1;
  return 0;
};

var currenciesListFilter = function currenciesListFilter(data) {
  var value = data.toUpperCase().trim();
  var filteredCurrencies = state.currencies.filter(function (curr) {
    return curr.includes(value);
  }).sort(function (curr1, curr2) {
    return sortByRelevancy(curr2, value) - sortByRelevancy(curr1, value);
  });
  return filteredCurrencies;
};

exports.currenciesListFilter = currenciesListFilter;
    ...
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            _context.next = 2;
            return fetch("".concat(_config.API_URL, "currencies"));
...
var createCurrencyObject = function createCurrencyObject(data) {
  return {
    from: data.base,
    amount: data.amount,
...
var searchCurrency = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            amount = _args2.length > 0 && _args2[0] !== undefined ? _args2[0] : 1;
            from = _args2.length > 1 && _args2[1] !== undefined ? _args2[1] : 'EUR';
            to = _args2.length > 2 && _args2[2] !== undefined ? _args2[2] : 'PLN';
            _context2.prev = 3;
            ...
            throw new Error('Wpisz minimum 1');
          ...
          case 6:
            ...
            throw new Error('Za duza kwota');

          case 8:
            _context2.next = 10;
            return fetch("".concat(_config.API_URL, "latest?amount=").concat(amount, "&from=").concat(from, "&to=").concat(to));
          ...
          case 13:
            data = _context2.sent;
            return _context2.abrupt("return", createCurrencyObject(data));
  ...
  return function searchCurrency() {
...
var createCurrencyTimeSeries = function createCurrencyTimeSeries(data) {
  var rates = Object.values(data.rates).map(function (el) {
    return Object.values(el)[0];
  });
  var to = Object.keys(Object.values(data.rates)[0])[0];
  var dates = Object.keys(data.rates).map(function (el) {
...
var formateDate = function formateDate(days) {
  var currentDate = new Date();
  var dateMinusDays = currentDate.setDate(currentDate.getDate() - days);
  return new Date(dateMinusDays).toISOString().split('T')[0];
};

var getCurrencyTimeSeries = /*#__PURE__*/function () {
    ...
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            from = _args3.length > 0 && _args3[0] !== undefined ? _args3[0] : 'EUR';
            to = _args3.length > 1 && _args3[1] !== undefined ? _args3[1] : 'PLN';
            days = _args3.length > 2 && _args3[2] !== undefined ? _args3[2] : 30;
            date = formateDate(days);
            _context3.next = 6;
            return fetch("".concat(_config.API_URL).concat(date, "..?to=").concat(to, "&from=").concat(from));
          ...
          case 9:
            data = _context3.sent;
            return _context3.abrupt("return", createCurrencyTimeSeries(data));
  ...
  return function getCurrencyTimeSeries() {
    return _ref3.apply(this, arguments);
  };
}();

exports.getCurrencyTimeSeries = getCurrencyTimeSeries;
},{"./config.js":"src/js/config.js"}],"src/flags/AUD.png":[function(require,module,exports) {
module.exports = "/AUD.067036c9.png";
},{}],"src/flags/BGN.png":[function(require,module,exports) {
module.exports = "/BGN.acc69a62.png";
},{}],"src/flags/CAD.png":[function(require,module,exports) {
module.exports = "/CAD.9d545ce8.png";
},{}],"src/flags/BRL.png":[function(require,module,exports) {
module.exports = "/BRL.363ed577.png";
},{}],"src/flags/CHF.png":[function(require,module,exports) {
module.exports = "/CHF.642d97cd.png";
},{}],"src/flags/CNY.png":[function(require,module,exports) {
module.exports = "/CNY.256a6dc5.png";
},{}],"src/flags/CZK.png":[function(require,module,exports) {
module.exports = "/CZK.fe32b57f.png";
},{}],"src/flags/DKK.png":[function(require,module,exports) {
module.exports = "/DKK.ea199aa6.png";
},{}],"src/flags/EUR.png":[function(require,module,exports) {
module.exports = "/EUR.ed0f8d63.png";
},{}],"src/flags/GBP.png":[function(require,module,exports) {
module.exports = "/GBP.a58d23be.png";
},{}],"src/flags/HKD.png":[function(require,module,exports) {
module.exports = "/HKD.642b1532.png";
},{}],"src/flags/HRK.png":[function(require,module,exports) {
module.exports = "/HRK.dfe1c991.png";
},{}],"src/flags/HUF.png":[function(require,module,exports) {
module.exports = "/HUF.918c4ff5.png";
},{}],"src/flags/IDR.png":[function(require,module,exports) {
module.exports = "/IDR.79810a57.png";
},{}],"src/flags/ILS.png":[function(require,module,exports) {
module.exports = "/ILS.d8e7d815.png";
},{}],"src/flags/INR.png":[function(require,module,exports) {
module.exports = "/INR.e85ee2ef.png";
},{}],"src/flags/ISK.png":[function(require,module,exports) {
module.exports = "/ISK.e9a07f0b.png";
},{}],"src/flags/JPY.png":[function(require,module,exports) {
module.exports = "/JPY.ba655b80.png";
},{}],"src/flags/KRW.png":[function(require,module,exports) {
module.exports = "/KRW.c9deac29.png";
},{}],"src/flags/MXN.png":[function(require,module,exports) {
module.exports = "/MXN.eb2df3f1.png";
},{}],"src/flags/MYR.png":[function(require,module,exports) {
module.exports = "/MYR.ad07ea46.png";
},{}],"src/flags/NOK.png":[function(require,module,exports) {
module.exports = "/NOK.9befee7b.png";
},{}],"src/flags/NZD.png":[function(require,module,exports) {
module.exports = "/NZD.d6076fac.png";
},{}],"src/flags/PHP.png":[function(require,module,exports) {
module.exports = "/PHP.f5b770f7.png";
},{}],"src/flags/PLN.png":[function(require,module,exports) {
module.exports = "/PLN.e5be4ab8.png";
},{}],"src/flags/RON.png":[function(require,module,exports) {
module.exports = "/RON.b288e522.png";
},{}],"src/flags/RUB.png":[function(require,module,exports) {
module.exports = "/RUB.87de1260.png";
},{}],"src/flags/SEK.png":[function(require,module,exports) {
module.exports = "/SEK.86d72ebf.png";
},{}],"src/flags/SGD.png":[function(require,module,exports) {
module.exports = "/SGD.d2f94927.png";
},{}],"src/flags/THB.png":[function(require,module,exports) {
module.exports = "/THB.cdfefe85.png";
},{}],"src/flags/TRY.png":[function(require,module,exports) {
module.exports = "/TRY.c2ed8980.png";
},{}],"src/flags/USD.png":[function(require,module,exports) {
module.exports = "/USD.f015fd79.png";
},{}],"src/flags/ZAR.png":[function(require,module,exports) {
module.exports = "/ZAR.3d1f0357.png";
},{}],"src/flags/*.png":[function(require,module,exports) {
module.exports = {
  "AUD": require("./AUD.png"),
  "BGN": require("./BGN.png"),
  "CAD": require("./CAD.png"),
...
},{"./AUD.png":"src/flags/AUD.png","./BGN.png":"src/flags/BGN.png","./CAD.png":"src/flags/CAD.png","./BRL.png":"src/flags/BRL.png","./CHF.png":"src/flags/CHF.png","./CNY.png":"src/flags/CNY.png","./CZK.png":"src/flags/CZK.png","./DKK.png":"src/flags/DKK.png","./EUR.png":"src/flags/EUR.png","./GBP.png":"src/flags/GBP.png","./HKD.png":"src/flags/HKD.png","./HRK.png":"src/flags/HRK.png","./HUF.png":"src/flags/HUF.png","./IDR.png":"src/flags/IDR.png","./ILS.png":"src/flags/ILS.png","./INR.png":"src/flags/INR.png","./ISK.png":"src/flags/ISK.png","./JPY.png":"src/flags/JPY.png","./KRW.png":"src/flags/KRW.png","./MXN.png":"src/flags/MXN.png","./MYR.png":"src/flags/MYR.png","./NOK.png":"src/flags/NOK.png","./NZD.png":"src/flags/NZD.png","./PHP.png":"src/flags/PHP.png","./PLN.png":"src/flags/PLN.png","./RON.png":"src/flags/RON.png","./RUB.png":"src/flags/RUB.png","./SEK.png":"src/flags/SEK.png","./SGD.png":"src/flags/SGD.png","./THB.png":"src/flags/THB.png","./TRY.png":"src/flags/TRY.png","./USD.png":"src/flags/USD.png","./ZAR.png":"src/flags/ZAR.png"}],"src/js/View.js":[function(require,module,exports) {
"use strict";
...
var _ = _interopRequireDefault(require("../flags/*.png"));
...
var View = /*#__PURE__*/function () {
  function View() {
    ...
    _defineProperty(this, "_dropdowns", document.querySelectorAll('.dropdown'));

    _defineProperty(this, "_currenciesLists", document.querySelectorAll('.currencies-list'));

    _defineProperty(this, "_inputSearchCurrencies", document.querySelectorAll('.input--search'));

    _defineProperty(this, "_inputAmount", document.querySelector('.input--amount'));

    _defineProperty(this, "_btnsDropdownOpen", document.querySelectorAll('.dropdown-open'));

    _defineProperty(this, "_btnFrom", document.querySelector('.btn-from'));

    _defineProperty(this, "_btnTo", document.querySelector('.btn-to'));

    _defineProperty(this, "_btnSubmit", document.querySelector('.btn--submit'));

    _defineProperty(this, "_errorText", document.querySelector('.error-text'));

    _defineProperty(this, "_btnSwap", document.querySelector('.btn--swap'));

    _defineProperty(this, "_resultAmount", document.querySelector('.result__amount'));

    _defineProperty(this, "_resultLastUpdate", document.querySelector('.result__info__last-update'));

    _defineProperty(this, "_resultOneXY", document.querySelector('.result__info__one-xy'));

    _defineProperty(this, "_resultOneYX", document.querySelector('.result__info__one-yx'));

    _defineProperty(this, "_chart", document.querySelector('#myChart'));

    _defineProperty(this, "_btnOpenDropdownChart", document.querySelector('.open-chart-dropdown'));

    _defineProperty(this, "_chartDropdown", document.querySelector('.chart__dropdown'));

    _defineProperty(this, "_chartMonths", document.querySelector('.chart__months'));

    _defineProperty(this, "_chartTitle", document.querySelector('.chart__title'));

    _defineProperty(this, "_myChart", void 0);

    _defineProperty(this, "inputSearchCurrenciesValue", void 0);

    _defineProperty(this, "daysChart", void 0);
  } // Chart


  _createClass(View, [{
    key: "updateChart",
    value: function updateChart(_ref) {
      var from = _ref.from,
          to = _ref.to,
          dates = _ref.dates,
          rates = _ref.rates;
      ...
      config.data.datasets[0].label = "1 ".concat(from, " = ");
      config.options.title.text = "".concat(from, " na ").concat(to);
      this.myChart.update();
    }
  }, {
    key: "addHandlerSelectMonthsChart",
    value: function addHandlerSelectMonthsChart(handler) {
      var _this = this;

      this._chartDropdown.addEventListener('click', function (e) {
        var btn = e.target.closest('.btn--chart');
        if (!btn) return;
        _this._chartMonths.innerHTML = btn.innerHTML;
        _this.daysChart = btn.dataset.days;
        handler();
      });
    }
  }, {
    key: "handlerCloseDropdownChart",
    value: function handlerCloseDropdownChart() {
      var _this2 = this;

      window.addEventListener('click', function (e) {
        if (e.target.closest('.open-chart-dropdown')) return;
        _this2._chartDropdown.style.display = 'none';
      });
    }
  }, {
    key: "handlerOpenDropdownChart",
    value: function handlerOpenDropdownChart() {
      var _this3 = this;

      this._btnOpenDropdownChart.addEventListener('click', function (e) {
        _this3._chartDropdown.style.display = 'block';
      });
    }
  }, {
    key: "renderChart",
    value: function renderChart(_ref2) {
      var from = _ref2.from,
          to = _ref2.to,
          rates = _ref2.rates,
          dates = _ref2.dates;
    ...
    key: "addHandlerSearchRateByEnter",
    value: function addHandlerSearchRateByEnter(handler) {
      var _this4 = this;

      this._inputAmount.addEventListener('keydown', function (e) {
        if (e.key !== 'Enter') return;
        e.preventDefault();
        handler();
        _this4._inputAmount.value = '';

        _this4._hideSearchError();

        _this4._chartMonths.innerHTML = '1 Miesiąc';
      });
    }
  }, {
    key: "addHandlerSearchRate",
    value: function addHandlerSearchRate(handler) {
      var _this5 = this;

      this._btnSubmit.addEventListener('click', function () {
        handler();
        _this5._inputAmount.value = '';

        _this5._hideSearchError();

        _this5._chartMonths.innerHTML = '1 Miesiąc';
      });
    }
  }, {
    key: "getSearchFormData",
    value: function getSearchFormData() {
      return {
    ...
    key: "_hideSearchError",
    value: function _hideSearchError() {
    ...
    value: function renderSearchError(err) {
    ...
    key: "renderSearchCurrency",
    value: function renderSearchCurrency(result) {
      this._resultAmount.innerHTML = "".concat(result.amount, " ").concat(result.from, " = ").concat(result.rate, " ").concat(result.to);
      this._resultLastUpdate.innerHTML = "Ostatnia Aktualizacja ".concat(result.updateDate);
      this._resultOneXY.innerHTML = "\n    1 ".concat(result.from, " = ").concat((Number(result.rate) / result.amount).toFixed(3), " ").concat(result.to);
      this._resultOneYX.innerHTML = "\n    1 ".concat(result.to, " = ").concat((result.amount / result.rate).toFixed(3), " ").concat(result.from);
    } // Currencies List

  }, {
    key: "_swapCurrencies",
    value: function _swapCurrencies() {
      var btn1Html = this._btnsDropdownOpen[0].innerHTML;
      var btn2Html = this._btnsDropdownOpen[1].innerHTML;
      var btn1data = this._btnsDropdownOpen[0].dataset.currency;
      var btn2data = this._btnsDropdownOpen[1].dataset.currency;
    ...
    key: "handlerSwapCurrencies",
    value: function handlerSwapCurrencies() {
      this._btnSwap.addEventListener('click', this._swapCurrencies.bind(this));
    }
  }, {
    key: "_chooseCurrency",
    value: function _chooseCurrency(e) {
      var btn = e.target.closest('.btn--search');
      if (!btn) return;
      var cur = btn.dataset.currency;

      if (document.querySelector(".btn-".concat(btn.closest('.currencies-list').dataset.list)).dataset.currency === cur) {
        this._swapCurrencies();

        return;
      }

      var markup = "\n      <img src=\"".concat(_.default[cur], "\" alt=\"").concat(cur, "\"/>\n      <p>").concat(cur, "</p>\n    ");
      btn.closest('.form__group').querySelector('.dropdown-open').dataset.currency = "".concat(cur);
      btn.closest('.form__group').querySelector('.btn-content').innerHTML = markup;
    }
  }, {
    key: "handlerChooseCurrency",
    value: function handlerChooseCurrency() {
      var _this6 = this;

      _toConsumableArray(this._currenciesLists).forEach(function (list) {
        list.addEventListener('click', _this6._chooseCurrency.bind(_this6));
      });
    }
  }, {
    key: "addHandlerFilterCurrencies",
    value: function addHandlerFilterCurrencies(handler) {
      var _this7 = this;

      _toConsumableArray(this._inputSearchCurrencies).forEach(function (input) {
        return input.addEventListener('input', function (e) {
          _this7.inputSearchCurrenciesValue = e.target.value;
          handler();
        });
      });
    }
  }, {
    key: "handlerCloseCurrenciesList",
    value: function handlerCloseCurrenciesList() {
      var _this8 = this;

      document.body.addEventListener('click', function (e) {
        if (e.target.closest('.dropdown-open') || e.target.closest('.input--search')) return;

        _toConsumableArray(_this8._inputSearchCurrencies).forEach(function (input) {
          return input.value = '';
        });

        _toConsumableArray(_this8._dropdowns).forEach(function (el) {
          return el.style.display = 'none';
        });
      });
    }
  }, {
    key: "handlerOpenCurrenciesList",
    value: function handlerOpenCurrenciesList(currencies) {
      var _this9 = this;
      ...
      this._form.addEventListener('click', function (e) {
        ...
        _toConsumableArray(_this9._dropdowns).forEach(function (e) {
          return e.style.display = 'none';
        });

        var btn = e.target.closest('.dropdown-open');
        if (!btn) return;

        _this9.renderCurrencies(currencies);

        btn.nextElementSibling.style.display = 'block';
        btn.nextElementSibling.querySelector('.input--search').focus();
        btn.nextElementSibling.addEventListener('keydown', function (e) {
          if (e.key !== 'Enter') return;
          e.preventDefault();
          var firstElement = btn.nextElementSibling.querySelector('.currencies-list').children[0];
          firstElement.click();
        });
      });
    }
  }, {
    key: "_clearCurrenciesList",
    value: function _clearCurrenciesList() {
      _toConsumableArray(this._currenciesLists).forEach(function (list) {
        list.innerHTML = '';
      });
    }
  }, {
    key: "_setNoCurrencies",
    value: function _setNoCurrencies() {
      var markup = '<p class="no-results">Nie znaleziono</p>';
    ...
    key: "_generateButton",
    value: function _generateButton(cur) {
      return "\n      <button class=\"btn btn--search\" data-currency=\"".concat(cur, "\">\n        <img src=\"").concat(_.default[cur], "\" alt=\"").concat(cur, "\" data-currency=\"").concat(cur, "\"/>\n        <p>").concat(cur, "</p>\n      </button>\n   ");
    }
  }, {
    key: "_setCurrenciesList",
    value: function _setCurrenciesList(currencies) {
      var _this10 = this;

      currencies.forEach(function (cur) {
        _toConsumableArray(_this10._currenciesLists).forEach(function (list) {
          return list.insertAdjacentHTML('beforeend', _this10._generateButton(cur));
        });
      });
    }
  }, {
    key: "renderCurrencies",
    value: function renderCurrencies(currencies) {
...
},{"../flags/*.png":"src/flags/*.png"}],"src/js/controller.js":[function(require,module,exports) {
"use strict";
...
var controlCurrencies = /*#__PURE__*/function () {
  var _ref = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee() {
    var curr;
    return regeneratorRuntime.wrap(function _callee$(_context) {
      while (1) {
        switch (_context.prev = _context.next) {
          case 0:
            curr = _View.default.inputSearchCurrenciesValue;

            _View.default.renderCurrencies(model.currenciesListFilter(curr));
  ...
  return function controlCurrencies() {
    return _ref.apply(this, arguments);
  };
}();

var controlSearchCurrency = /*#__PURE__*/function () {
  var _ref2 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee2() {
    var formData;
    return regeneratorRuntime.wrap(function _callee2$(_context2) {
      while (1) {
        switch (_context2.prev = _context2.next) {
          case 0:
            _context2.prev = 0;
            formData = _View.default.getSearchFormData();
            _context2.t0 = _View.default;
            _context2.next = 5;
            return model.searchCurrency(formData.amount, formData.from, formData.to);

          case 5:
            _context2.t1 = _context2.sent;

            _context2.t0.renderSearchCurrency.call(_context2.t0, _context2.t1);

            _context2.t2 = _View.default;
            _context2.next = 10;
            return model.getCurrencyTimeSeries(formData.from, formData.to);

          case 10:
            _context2.t3 = _context2.sent;

            _context2.t2.updateChart.call(_context2.t2, _context2.t3);
          ...
          case 14:
            ...
            _View.default.renderSearchError(_context2.t4.message);
  ...
  return function controlSearchCurrency() {
    return _ref2.apply(this, arguments);
  };
}();

var controlChartByDays = /*#__PURE__*/function () {
  var _ref3 = _asyncToGenerator( /*#__PURE__*/regeneratorRuntime.mark(function _callee3() {
    var formData, daysChart, dataTimeSeries;
    return regeneratorRuntime.wrap(function _callee3$(_context3) {
      while (1) {
        switch (_context3.prev = _context3.next) {
          case 0:
            formData = _View.default.getSearchFormData();
            daysChart = _View.default.daysChart;
            _context3.next = 4;
            return model.getCurrencyTimeSeries(formData.from, formData.to, daysChart);

          case 4:
            dataTimeSeries = _context3.sent;

            _View.default.updateChart(dataTimeSeries);
  ...
  return function controlChartByDays() {
    return _ref3.apply(this, arguments);
  };
}();
    ...
    return regeneratorRuntime.wrap(function _callee4$(_context4) {
      while (1) {
        switch (_context4.prev = _context4.next) {
          ...
          case 2:
            _context4.t0 = _View.default;
            _context4.next = 5;
            return model.searchCurrency();

          case 5:
            _context4.t1 = _context4.sent;

            _context4.t0.renderSearchCurrency.call(_context4.t0, _context4.t1);

            _View.default.addHandlerSearchRate(controlSearchCurrency);

            _View.default.addHandlerSearchRateByEnter(controlSearchCurrency);

            _View.default.addHandlerFilterCurrencies(controlCurrencies);

            _View.default.handlerOpenCurrenciesList(model.state.currencies);

            _View.default.handlerSwapCurrencies();

            _View.default.handlerChooseCurrency();

            _View.default.handlerCloseCurrenciesList();

            _context4.t2 = _View.default;
            _context4.next = 17;
            return model.getCurrencyTimeSeries();

          case 17:
            _context4.t3 = _context4.sent;

            _context4.t2.renderChart.call(_context4.t2, _context4.t3);

            _View.default.handlerOpenDropdownChart();

            _View.default.addHandlerSelectMonthsChart(controlChartByDays);

            _View.default.handlerCloseDropdownChart();
...
if ((!parent || !parent.isParcelRequire) && typeof WebSocket !== 'undefined') {
  ...
  var ws = new WebSocket(protocol + '://' + hostname + ':' + "8430" + '/');
